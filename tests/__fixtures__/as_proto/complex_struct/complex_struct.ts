...
size += this.Properties.length > 0 ? 1 + __proto.Sizer.varint64(this.Properties.length) + this.Properties.length : 0
            ...
            encodeU8Array(encoder: __proto.Encoder = new __proto.Encoder(new Array<u8>())):Array<u8> {
                const buf = encoder.buf;
        
if (this.Properties.length > 0) { encoder.uint32(0xa); encoder.uint32(this.Properties.length); encoder.string(this.Properties) }
...
if (this.seconds != 0) { encoder.uint32(0x8); encoder.int64(this.seconds) }
if (this.nanos != 0) { encoder.uint32(0x10); encoder.int32(this.nanos) }
...
break;
            ...
            if (this.Labels.length > 0) {
                for (let n:i32 = 0; n < this.Labels.length; n++) {
                    encoder.uint32(0xa); encoder.uint32(this.Labels[n].length); encoder.string(this.Labels[n])
                }
            }
...
public MapMessages:Map<string, Message_Message> = new Map<string, Message_Message>();;
public Properties1:external.Properties= new external.Properties();
public Properties2:external.external.Properties= new external.external.Properties();
...
case 2: {
            ...
            obj.Labels = Labels.decodeDataView(new DataView(decoder.view.buffer, decoder.pos+decoder.view.byteOffset, length))
            decoder.skip(length);
...
case 11: {
            ...
            const length = decoder.uint32();
            obj.Properties1 = external.Properties.decodeDataView(new DataView(decoder.view.buffer, decoder.pos+decoder.view.byteOffset, length))
            decoder.skip(length);
...
case 12: {
            ...
            const length = decoder.uint32();
            obj.Properties2 = external.external.Properties.decodeDataView(new DataView(decoder.view.buffer, decoder.pos+decoder.view.byteOffset, length))
            decoder.skip(length);
...
size += this.String.length > 0 ? 1 + __proto.Sizer.varint64(this.String.length) + this.String.length : 0
...
size += this.Network == 0 ? 0 : 1 + __proto.Sizer.uint32(this.Network)
            ...
            if (this.Properties2 != null) {
                const f:external.external.Properties = this.Properties2 as external.external.Properties;
                const messageSize = f.size();
...
if (this.String.length > 0) { encoder.uint32(0xa); encoder.uint32(this.String.length); encoder.string(this.String) }
...
if (this.Status1 != 0) { encoder.uint32(0x18); encoder.uint32(this.Status1) }
if (this.Status2 != 0) { encoder.uint32(0x20); encoder.uint32(this.Status2) }
if (this.Network != 0) { encoder.uint32(0x28); encoder.uint32(this.Network) }

            if (this.Strings.length > 0) {
                for (let n:i32 = 0; n < this.Strings.length; n++) {
                    encoder.uint32(0x32); encoder.uint32(this.Strings[n].length); encoder.string(this.Strings[n])
                }
            }
            ...
            if (this.MapString.size > 0) {
                ...
                for (let i = 0; i < keys.length; i++) {
                    ...
                    if (size > 0) {
                        encoder.uint32(0x3a)
                        encoder.uint32(size)
                        if (key.length > 0) { encoder.uint32(0xa); encoder.uint32(key.length); encoder.string(key) }
                        if (value.length > 0) { encoder.uint32(0x12); encoder.uint32(value.length); encoder.string(value) }
                    }
                }
            }
...
public String:string = '';
public Messages:Map<string, Message_Message> = new Map<string, Message_Message>();;
...
case 2: {
            ...
            const length = decoder.uint32();
            obj.Timestamp = google.protobuf.Timestamp.decodeDataView(new DataView(decoder.view.buffer, decoder.pos+decoder.view.byteOffset, length))
            decoder.skip(length);
...
break;
            ...
            if (this.Timestamp != null) {
                const f:google.protobuf.Timestamp = this.Timestamp as google.protobuf.Timestamp;
                const messageSize = f.size();
            ...
            if (this.Strings.length > 0) {
                for (let n:i32 = 0; n < this.Strings.length; n++) {
                    encoder.uint32(0xa); encoder.uint32(this.Strings[n].length); encoder.string(this.Strings[n])
                }
            }
            ...
            function __decodeMap_string_string(parentDecoder: __proto.Decoder, length: i32, map: Map<string, string>):void {
                const decoder = new __proto.Decoder(new DataView(parentDecoder.view.buffer, parentDecoder.pos+parentDecoder.view.byteOffset, length));
            ...
            function __decodeMap_string_Message_Message(parentDecoder: __proto.Decoder, length: i32, map: Map<string, Message_Message>):void {
                const decoder = new __proto.Decoder(new DataView(parentDecoder.view.buffer, parentDecoder.pos+parentDecoder.view.byteOffset, length));
            ...
            const length = decoder.uint32();
            value = Message_Message.decodeDataView(new DataView(decoder.view.buffer, decoder.pos+decoder.view.byteOffset, length))
            decoder.skip(length);
                ...
                function __sizeMapEntry_string_string(key: string, value: string): u32 {
                    return (key.length > 0 ? 1 + __proto.Sizer.varint64(key.length) + key.length : 0) + 
                           (value.length > 0 ? 1 + __proto.Sizer.varint64(value.length) + value.length : 0);
                }
                ...
                function __sizeMapEntry_string_Message_Message(key: string, value: Message_Message): u32 {
                    const keySize = key.length > 0 ? 1 + __proto.Sizer.varint64(key.length) + key.length : 0;
