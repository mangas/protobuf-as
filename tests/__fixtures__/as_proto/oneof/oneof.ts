...
if (this.UInt32 != 0) { encoder.uint32(0x8); encoder.uint32(this.UInt32) }
...
case 1: {
            ...
            obj.Branch1 = Branch1.decodeDataView(new DataView(decoder.view.buffer, decoder.pos+decoder.view.byteOffset, length))
            decoder.skip(length);
...
case 2: {
            ...
            const length = decoder.uint32();
            obj.Branch2 = Branch2.decodeDataView(new DataView(decoder.view.buffer, decoder.pos+decoder.view.byteOffset, length))
            decoder.skip(length);
...
size += this.NonOneOf1.length > 0 ? 1 + __proto.Sizer.varint64(this.NonOneOf1.length) + this.NonOneOf1.length : 0
size += this.Branch3.length > 0 ? 1 + __proto.Sizer.varint64(this.Branch3.length) + this.Branch3.length : 0
size += this.Branch4 == 0 ? 0 : 1 + __proto.Sizer.int32(this.Branch4)
size += this.NonOneOf2.length > 0 ? 1 + __proto.Sizer.varint64(this.NonOneOf2.length) + this.NonOneOf2.length : 0
...
if (this.NonOneOf1.length > 0) { encoder.uint32(0x1a); encoder.uint32(this.NonOneOf1.length); encoder.string(this.NonOneOf1) }
if (this.Branch3.length > 0) { encoder.uint32(0x22); encoder.uint32(this.Branch3.length); encoder.string(this.Branch3) }
if (this.Branch4 != 0) { encoder.uint32(0x28); encoder.int32(this.Branch4) }
if (this.NonOneOf2.length > 0) { encoder.uint32(0x32); encoder.uint32(this.NonOneOf2.length); encoder.string(this.NonOneOf2) }
