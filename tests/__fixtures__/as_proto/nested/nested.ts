...
case 5: {
            ...
            obj.Id = Id.decodeDataView(new DataView(decoder.view.buffer, decoder.pos+decoder.view.byteOffset, length))
            decoder.skip(length);
...
size += this.Name.length > 0 ? 1 + __proto.Sizer.varint64(this.Name.length) + this.Name.length : 0
size += this.Surname.length > 0 ? 1 + __proto.Sizer.varint64(this.Surname.length) + this.Surname.length : 0
...
if (this.Name.length > 0) { encoder.uint32(0xa); encoder.uint32(this.Name.length); encoder.string(this.Name) }
if (this.Surname.length > 0) { encoder.uint32(0x12); encoder.uint32(this.Surname.length); encoder.string(this.Surname) }
if (this.Age != 0) { encoder.uint32(0x18); encoder.int32(this.Age) }
if (this.Weight != 0) { encoder.uint32(0x25); encoder.float(this.Weight) }
...
size += this.Number.length > 0 ? 1 + __proto.Sizer.varint64(this.Number.length) + this.Number.length : 0
size += this.Serial.length > 0 ? 1 + __proto.Sizer.varint64(this.Serial.length) + this.Serial.length : 0
...
if (this.Number.length > 0) { encoder.uint32(0xa); encoder.uint32(this.Number.length); encoder.string(this.Number) }
if (this.Serial.length > 0) { encoder.uint32(0x12); encoder.uint32(this.Serial.length); encoder.string(this.Serial) }
