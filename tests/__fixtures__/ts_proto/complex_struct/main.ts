...
export const Labels = {
  ...
  fromJSON(object: any): Labels {
    return { Labels: Array.isArray(object?.Labels) ? object.Labels.map((e: any) => String(e)) : [] };
  },
...
export const Message = {
  ...
  fromJSON(object: any): Message {
    return {
      ...
      Services: Array.isArray(object?.Services) ? object.Services.map((e: any) => message_ServiceFromJSON(e)) : [],
    };
  },
  ...
  toJSON(message: Message): unknown {
    ...
    message.Labels !== undefined && (obj.Labels = message.Labels ? Labels.toJSON(message.Labels) : undefined);
    message.Status1 !== undefined && (obj.Status1 = statusToJSON(message.Status1));
    message.Status2 !== undefined && (obj.Status2 = statusToJSON(message.Status2));
    message.Network !== undefined && (obj.Network = message_ServiceToJSON(message.Network));
    if (message.Strings) {
    ...
    message.Properties1 !== undefined &&
      (obj.Properties1 = message.Properties1 ? Properties.toJSON(message.Properties1) : undefined);
    message.Properties2 !== undefined &&
      (obj.Properties2 = message.Properties2 ? Properties1.toJSON(message.Properties2) : undefined);
    if (message.Services) {
...
export const Message_Message_MessagesEntry = {
  ...
  toJSON(message: Message_Message_MessagesEntry): unknown {
    ...
    message.value !== undefined && (obj.value = message.value ? Message_Message.toJSON(message.value) : undefined);
    return obj;
  },
