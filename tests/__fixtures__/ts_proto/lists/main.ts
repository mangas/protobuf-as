...
export const Lists = {
  ...
  fromJSON(object: any): Lists {
    return {
      Enums: Array.isArray(object?.Enums) ? object.Enums.map((e: any) => enumFromJSON(e)) : [],
      Strings: Array.isArray(object?.Strings) ? object.Strings.map((e: any) => String(e)) : [],
      Bytes: Array.isArray(object?.Bytes) ? object.Bytes.map((e: any) => bytesFromBase64(e)) : [],
      Messages: Array.isArray(object?.Messages) ? object.Messages.map((e: any) => Message.fromJSON(e)) : [],
      Ints: Array.isArray(object?.Ints) ? object.Ints.map((e: any) => Number(e)) : [],
    };
  },
