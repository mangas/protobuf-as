...
export interface OneOf {
  Messages?: { $case: "Branch1"; Branch1: Branch1 } | { $case: "Branch2"; Branch2: Branch2 };
  NonOneOf1: string;
  SecondMessage?: { $case: "Branch3"; Branch3: string } | { $case: "Branch4"; Branch4: number };
  NonOneOf2: string;
}
...
export const Branch2 = {
  ...
  fromJSON(object: any): Branch2 {
    return { UInt32: isSet(object.UInt32) ? Number(object.UInt32) : 0 };
  },
...
export const OneOf = {
  ...
  toJSON(message: OneOf): unknown {
    ...
    message.Messages?.$case === "Branch1" &&
      (obj.Branch1 = message.Messages?.Branch1 ? Branch1.toJSON(message.Messages?.Branch1) : undefined);
    message.Messages?.$case === "Branch2" &&
      (obj.Branch2 = message.Messages?.Branch2 ? Branch2.toJSON(message.Messages?.Branch2) : undefined);
    message.NonOneOf1 !== undefined && (obj.NonOneOf1 = message.NonOneOf1);
    message.SecondMessage?.$case === "Branch3" && (obj.Branch3 = message.SecondMessage?.Branch3);
    message.SecondMessage?.$case === "Branch4" && (obj.Branch4 = Math.round(message.SecondMessage?.Branch4));
