...
export const Elementaries = {
  ...
  fromJSON(object: any): Elementaries {
    return {
      ...
      EmptyBytes: isSet(object.EmptyBytes) ? bytesFromBase64(object.EmptyBytes) : new Uint8Array(),
      EmptyString: isSet(object.EmptyString) ? String(object.EmptyString) : "",
      EmptyInt64: isSet(object.EmptyInt64) ? Number(object.EmptyInt64) : 0,
      EmptyInt32: isSet(object.EmptyInt32) ? Number(object.EmptyInt32) : 0,
      EmptyBool: isSet(object.EmptyBool) ? Boolean(object.EmptyBool) : false,
    };
  },
  ...
  toJSON(message: Elementaries): unknown {
    ...
    message.EmptyBytes !== undefined &&
      (obj.EmptyBytes = base64FromBytes(message.EmptyBytes !== undefined ? message.EmptyBytes : new Uint8Array()));
    message.EmptyString !== undefined && (obj.EmptyString = message.EmptyString);
    message.EmptyInt64 !== undefined && (obj.EmptyInt64 = Math.round(message.EmptyInt64));
    message.EmptyInt32 !== undefined && (obj.EmptyInt32 = Math.round(message.EmptyInt32));
