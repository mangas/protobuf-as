...
export const Value = {
  ...
  fromJSON(object: any): Value {
    return { Int32s: Array.isArray(object?.Int32s) ? object.Int32s.map((e: any) => Number(e)) : [] };
  },
...
export const Maps_StringExternalMapValueEntry = {
  ...
  toJSON(message: Maps_StringExternalMapValueEntry): unknown {
    const obj: any = {};
    message.key !== undefined && (obj.key = message.key);
    message.value !== undefined && (obj.value = message.value ? MapValue.toJSON(message.value) : undefined);
    return obj;
  },
